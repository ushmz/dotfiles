local function config()
  ...
  local active_bg = colors.palette.dragonBlack3

  local subtext = colors.palette.dragonGray2
  local inactive_bg = colors.palette.dragonBlack2
  ...
  require("bufferline").setup({
    ...
    highlights = {
      ...
      tab_close = { bg = nil, fg = colors.palette.dragonRed },
      ...
      separator = { bg = inactive_bg, fg = nil },
      separator_visible = { bg = inactive_bg, fg = nil },
      separator_selected = { bg = active_bg, fg = nil },
