local function config()
	require("octo").setup({
		...
		mappings = {
			...
			submit_win = {
				approve_review = { lhs = "<C-g>a", desc = "[A]pprove review" },
				comment_review = { lhs = "<C-g>m", desc = "co[m]ment review" },
				request_changes = { lhs = "<C-g>r", desc = "[R]equest changes review" },
				close_review_tab = { lhs = "<C-g>c", desc = "[C]lose review tab" },
			},
			review_diff = {
