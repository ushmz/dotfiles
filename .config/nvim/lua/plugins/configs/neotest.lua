...
local function set_hl()
	...
	vim.api.nvim_set_hl(0, "NeotestRunning", { fg = "#81A2BE" })
	vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = "#8aBEB7" })
	vim.api.nvim_set_hl(0, "NeotestFile", { fg = "#B5BD68" })
	vim.api.nvim_set_hl(0, "NeotestDir", { fg = "#81A2BE" })
	vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = "#CC6666" })
	...
	vim.api.nvim_set_hl(0, "NeotestTest", { fg = "#B4B4B4" })
end
