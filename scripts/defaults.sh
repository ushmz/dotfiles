...
# Set computer name
# sudo scutil --set ComputerName "kahma"
# sudo scutil --set HostName "kahma"
# sudo scutil --set LocalHostName "kahma"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "kahma"
...
# Scrollbars (`WhenScrolling`, `Automatic` and `Always`)
...
defaults write NSGlobalDomain AppleLocale -string "en_JP@calendar=japanese"
...
# Set standby delay to n seconds.
